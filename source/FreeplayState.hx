...
class FreeplayState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		var accepted = controls.ACCEPT;
	        var space = FlxG.keys.justPressed.SPACE#if html5 || _virtualpad.buttonX.justPressed #end;
		var ctrl = FlxG.keys.justPressed.CONTROL#if html5 || _virtualpad.buttonC.justPressed #end;
		...
		else if(controls.RESET#if html5 || _virtualpad.buttonY.justPressed #end)
		{
